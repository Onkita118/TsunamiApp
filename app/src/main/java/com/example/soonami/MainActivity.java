...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                urlConnection = (HttpURLConnection) url.openConnection();  //setting up http request
                urlConnection.setRequestMethod("GET");                     //setting up http request
                urlConnection.setReadTimeout(10000 /* milliseconds */);    //setting up http request
                urlConnection.setConnectTimeout(15000 /* milliseconds */); //setting up http request.......

                urlConnection.connect();                                   //establishing http connection ......


                inputStream = urlConnection.getInputStream();              // receiving response and making sense to our app
                jsonResponse = readFromStream(inputStream);                // receiving response and making sense to our app ......
            } catch (IOException e) {
